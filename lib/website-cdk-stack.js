...
class WebsiteCdkStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const myHostedZone = Route53.HostedZone.fromHostedZoneAttributes(this, 'HostedZone', {
      ...
      zoneName: 'lambdacicd.com',
    })
    
    const certificate = new CertificateManager.Certificate(this, 'Certificate', {
      domainName: 'website1.lambdacicd.com',
      certificateName: 'website1.lambdacicd.com', // Optionally provide an certificate name
    ...
    const distribution = new Cloudfront.CloudFrontWebDistribution(this, 'MyCloudFrontDistribution', {      
      ...
      viewerCertificate: {
        aliases: ['website1.lambdacicd.com'], // Replace with your domain alias
        props: {
    ...
    const aliasRecord = new Route53.ARecord(this, 'MyAliasRecord', {
      ...
      zone: myHostedZone,
      recordName: 'website1.lambdacicd.com',
    });
